...
if __name__ == '__main__':
    ...
    slice_path = os.path.join(base_res_dir, 'slice/')
    os.makedirs(slice_path)
    ...
    os.system(
        r'python .\detect.py --img 416 --cfg .\\' + argv[3].split('\\')[-1] + ' --weights .\\' + argv[2].split('\\')[-1] + ' --source ' + slice_path + ' --save-txt --output ' + slice_res_path)
